...
function Dash() {
  ...
  return (
    <div className="space-y-6 pb-8 animate-page-in">
      ...
      {/* ── SPOT 4: Dashboard Promo Video Strip ── */}
      <div style={{
        background:'#0A0A0A', borderRadius:18, overflow:'hidden',
        border:'1px solid rgba(255,107,0,0.18)',
        boxShadow:'0 8px 32px rgba(0,0,0,0.18)',
        position:'relative'
      }}>
        {/* Orange top bar */}
        <div style={{position:'absolute',top:0,left:0,right:0,height:3,background:'#FF6B00',zIndex:2}}/>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{fontFamily:"'Silkscreen',monospace",fontSize:9,color:'#FF6B00',letterSpacing:'.18em',textTransform:'uppercase'}}>
              ▶ // Product Demo
            </div>
            <h3 style={{fontFamily:"'Space Grotesk','Inter',sans-serif",fontWeight:700,fontSize:22,color:'#FFFFFF',lineHeight:1.25,letterSpacing:'-0.02em'}}>
              See GasAgency Hub<br/>
              <span style={{color:'#FF6B00'}}>In Action.</span>
            </h3>
            <p style={{fontFamily:"'Inter',sans-serif",fontSize:13,color:'rgba(255,255,255,0.5)',lineHeight:1.7}}>
              Watch how billing, udhari, payments, and delivery management all come together in one platform.
            </p>
            <div style={{display:'flex',gap:10,flexWrap:'wrap',marginTop:8}}>
              <a
                href="https://wa.me/918605601801?text=Hello%20Jayesh%2C%20I%20want%20to%20start%20a%20free%20trial%20for%20LPG%20Agency%20ERP."
                target="_blank" rel="noopener noreferrer"
                style={{display:'inline-flex',alignItems:'center',gap:8,padding:'9px 18px',background:'#FF6B00',color:'#fff',borderRadius:8,fontFamily:"'Inter',sans-serif",fontWeight:600,fontSize:12,textDecoration:'none'}}
              >
                Start Free Trial →
              </a>
            </div>
          ...
          <div style={{background:'#111',borderLeft:'1px solid rgba(255,255,255,0.06)'}}>
            {/* Fake browser bar */}
            <div style={{
        ...
        <div style={{
          ...
          color:'#fff',background:'#FF6B00',padding:'4px 10px',
