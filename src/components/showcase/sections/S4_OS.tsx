  ...
  return (
    <section style={{ height: '180vh', position: 'relative', padding: '0 8vw' }}>
      <div style={{
        ...
        <div style={{
          fontFamily: "'VT323', monospace", fontSize: 'clamp(42px, 5.5vw, 82px)',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6, marginTop: 28 }}>
          {MODULES.map((mod, i) => (
            <div key={mod} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <div style={{
                width: 4, height: 4,
                background: i % 2 === 0 ? '#FF6A00' : '#888899', borderRadius: 1,
              }} />
              <span style={{
                fontFamily: "'JetBrains Mono', monospace", fontSize: '10px',
                color: 'rgba(16,16,16,0.6)', letterSpacing: '0.12em', textTransform: 'uppercase',
              }}>{mod}</span>
            </div>
          ))}
        </div>
