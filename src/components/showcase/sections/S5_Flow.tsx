    ...
    <section style={{ height: '140vh', position: 'relative', padding: '0 8vw' }}>
      <div style={{
        ...
        <div>
          ...
          <div style={{
            fontFamily: "'VT323', monospace", fontSize: 'clamp(36px, 4.5vw, 66px)',
              ...
              <div key={step} style={{ display: 'flex', alignItems: 'center' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
                  <div style={{
                    ...
                    border: '1px solid rgba(16,16,16,0.1)', minWidth: 120,
                    textAlign: 'center', letterSpacing: '0.08em',
                  }}>{step}</div>
                  {i < FLOW.length - 1 && (
                    <div style={{
                      fontFamily: "'JetBrains Mono', monospace", fontSize: '9px',
                      color: '#FF6A00', padding: '3px 0', textAlign: 'center', width: '100%',
                    }}>↓</div>
                  )}
                </div>
              </div>
